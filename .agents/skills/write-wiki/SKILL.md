---
name: write-wiki
description: Wiki article conventions for Pokemon Amber. Use when creating or updating character profiles, location docs, lore pages, or event documentation.
---

# Wiki Style Guide

This document outlines the core principles and style guidelines for writing and editing articles for the Pokemon Amber wiki. Following these guidelines will ensure the wiki remains a clear, consistent, and credible resource.

> **Note:** For Pokemon Amber-specific canon rules, source priority, and research process, read [resources/amber-canon.md](resources/amber-canon.md) before writing any article that involves official Pokemon canon or fan theories.
...
- **Citation Format:** Use a consistent Markdown format for citations. The path should be relative to the article's location. For example:
...
- **Internal Linking:** On the first mention of a character, location, faction, or key event, create a link to its corresponding wiki article. This creates a navigable web of information.
- **Link Format:** Use relative links. For example, when linking to an antagonist's page from a protagonist's page: `[Antagonist Name](./Antagonist_Name.md)`

---

## II. Article Structure & Templates

Article structure should be flexible, adapting to the subject's importance in the story. Use the following as adaptable templates, not rigid rules. Omit sections that are not relevant or for which there is little information.

- **Discretion for New Categories:** If existing categories do not adequately encompass a subject, new categories (and corresponding directories) can be created as needed. Ensure new categories are logical and well-defined.
...
**For a Significant Entity (e.g., a unique creature, a special item):**
