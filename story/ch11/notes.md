...
### Erika
Based on Erika from the Pokemon games ([Bulbapedia][bulbapedia-erika]):
...
### Kaede
Based on Kaede from the manga "How I Became a Pokemon Card" ([Bulbapedia][bulbapedia-kaede]):
- Childhood friends with Erika, the Celadon Gym Leader
- Severely allergic to pollen, flowers, and Grass-type Pokemon in general (hence constant sneezing around Oddish)
...
**Two insert locations:**

**1. Store stop (lines 53-59).** After renting the car in Viridian, before driving to Pallet. Fuji pulls over at a shop. Currently the prose goes straight from "paid for a day's rental" to "Get in." The new beat goes between those --- Fuji tells Amber to wait, ducks into a shop, comes back with flowers and a paper bag (the wine). Amber sees the purchase from the car.

The current transition is:

> After Dr. Fuji paid for a day's rental, he yanked open the passenger door and ordered, "Get in."

Insert the store stop between the rental and the "Get in." Fuji's energy shifts briefly --- the taut agitation from the morning softens into something fragile and rehearsed. He's dressing up for a reunion he's built in his head for fifteen years.

**2. Doorstep arrival (lines 77-91).** When Fuji pulls Amber from the car and pushes her toward Delia. Currently the published prose has him grab her arm and pull her out. Revised version: he's also carrying the flowers, wine tucked under his arm. The flowers should be visible to Delia --- they're part of the domestic fantasy he's staging. The wine can be subtler (paper bag, tucked away).

The current doorstep beat is:
...
**Constraints:**
- The store stop should be 3-5 sentences max. In and out. Fuji doesn't explain why.
- Amber's reaction to the flowers is mild curiosity or confusion, not alarm
